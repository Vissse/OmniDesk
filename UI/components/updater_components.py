...
class UpdateRowWidget(QWidget):
    def __init__(self, data, parent_page):
        ...
        self.curr_lbl = QLabel(data['current'])
        ...
        self.new_lbl = QLabel(data['new'])

        text_layout.addWidget(self.name_lbl)
        text_layout.addSpacing(5)
        text_layout.addWidget(self.curr_lbl)
        text_layout.addWidget(self.sep_lbl)
        text_layout.addWidget(self.new_lbl)
    ...
    def update_style(self):
        ...
        self.curr_lbl.setStyleSheet(f"font-size: 13px; color: {COLORS['sub_text']}; background: transparent;")
        self.new_lbl.setStyleSheet(f"font-size: 13px; font-weight: bold; color: {COLORS['accent']}; background: transparent;")
